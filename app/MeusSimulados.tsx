      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.containerMaterias}>
          <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.scroll}>
            {["Enem", "Fuvest", "Vunesp"].map((item, i) => (
              <TouchableOpacity
                key={i}
                style={[styles.cardMaterias, item === "Enem" && styles.cardAtivo]}
                onPress={() => {
                  if (item === "Fuvest") {
                    router.push('/SimuladosFuvest');
                  } else if (item === "Vunesp") {
                    router.push('/SimuladosVunesp');
                  }
                }}
              >
        ...
        <View style={styles.containerCardImagem}>
            ...
            <View style={styles.cardImagem}>
                ...
                <Text style={[styles.descricao, { fontFamily: 'Poppins_400Regular' }]}>Teste seus conhecimentos com um simulado baseado na edição de 2023.</Text>
                <View style={styles.parteBranca}>
            ...
            <View style={styles.cardImagem}>
                ...
                <Text style={[styles.descricao, { fontFamily: 'Poppins_400Regular' }]}>Teste seus conhecimentos com um simulado baseado na edição de 2022.</Text>
                <View style={styles.parteBranca}>
