        ...
        <SafeAreaView style={styles.tela}>
            <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
                <View style={styles.containerFoto}>
                    ...
                    />
                    <Text style={[styles.nome, { fontFamily: 'Poppins_600SemiBold' }]}>Gustavo Henrique</Text>
                    <Text style={[styles.email, { fontFamily: 'Poppins_400Regular' }]}>gustavo.souza89@gmail.com</Text>
                </View>
                ...
                <View style={styles.containerCards}>
                    <View style={styles.card1}>
                        <TouchableOpacity style={styles.editarPerfil}>
                            ...
                            <Text style={[styles.titulo, { fontFamily: 'Poppins_500Medium' }]}>Editar Perfil</Text>
                            <Image source={require('../assets/images/arrow.png')} style={styles.seta}/>
                        </TouchableOpacity>

                        <TouchableOpacity style={styles.redefinirSenha}>
                    ...
                    <View style={styles.card2}>
                        ...
                        <TouchableOpacity style={styles.acessibilidade}>
                            ...
                            <Text style={[styles.titulo, { fontFamily: 'Poppins_500Medium' }]}>Deletar Conta</Text>
            ...
            <View style={styles.menu}>
                <View style={styles.contentMenu}>
                    <TouchableOpacity style={styles.btnHome} onPress={() => router.push('/HomeLogin')}>
                        <Image
                    ...
                    <TouchableOpacity style={styles.btnConfig}>
                        <Image
                            source={require('../assets/images/configAtivo.png')}
                        />
