...
import { AntDesign,Entypo } from '@expo/vector-icons'; // ícone opcional

export default function TelaDicaEstudos() {
  const router = useRouter();
  const [ativo, setAtivo] = useState("Natureza");
        ...
        <View style={styles.containerCard}>
          <TouchableOpacity style={styles.cardsItem}>
            <View style={styles.cardContentItem}>
              <Entypo name="lab-flask" size={24} color="#5D64F5" style={styles.icon} />
              <Text style={styles.cardTextoItem}>Química</Text>
            </View>
          </TouchableOpacity>

          <TouchableOpacity style={styles.cardsItem}>
            <View style={styles.cardContentItem}>
              <Entypo name="leaf" size={24} color="#5D64F5" style={styles.icon} />
              <Text style={styles.cardTextoItem}>Biologia</Text>
            </View>
          </TouchableOpacity>
          ...
          <TouchableOpacity style={styles.cardsItem}>
            <View style={styles.cardContentItem}>
              ...
              <Text style={styles.cardTextoItem}>Física</Text>
            </View>
          </TouchableOpacity>
        </View>
      </ScrollView>
