    ...
    <SafeAreaView style={styles.tela}>
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        <View style={styles.contentBemVindo}>
            {/* Foto de perfil */}
            <Image
                source={require('../assets/images/che.png')}
                style={styles.avatar}
            />
        ...
        <View style={styles.containerSaudeMental}>
          <View style={styles.cardSaude}>
            <TouchableOpacity style={styles.btnSaude} onPress={() => router.push('/SaudeMental')}>
              <Text style={styles.textobtnSaude}>SAUDE</Text>
            </TouchableOpacity>
          </View>
        </View>
        <View style={styles.container}>
          ...
          <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.scroll}>
            ...
            <TouchableOpacity style={styles.card}>
            <Image  source={require('../assets/images/anotações.png')} style={styles.icon} />
              <Text style={[styles.label, { fontFamily: 'Poppins_600SemiBold' }]}>Minhas Anotações</Text>
            </TouchableOpacity>

            <TouchableOpacity style={styles.card} onPress={() => router.push('/MeusSimulados')}>
            ...
            <TouchableOpacity style={styles.card} onPress={() => router.push('/DicasEstudos')}>
      ...
      <View style={styles.menu}>
          <View style={styles.contentMenu}>
            <TouchableOpacity style={styles.btnHome}>
                <Image
                    source={require('../assets/images/HomeAtivo.png')}
                    style={styles.img2}
                />
                <View style={styles.linha}></View>
            </TouchableOpacity>

            <TouchableOpacity style={styles.btnAgenda}>
                <Image
                    source={require('../assets/images/inativo.png')}
                    style={styles.img}
                />
            </TouchableOpacity>
            ...
            <TouchableOpacity style={styles.btnConfig} onPress={() => router.push('/Configuracoes')}>
                <Image
                    source={require('../assets/images/Configurações.png')}
                    style={styles.img4}
                />
            </TouchableOpacity>
          </View>
