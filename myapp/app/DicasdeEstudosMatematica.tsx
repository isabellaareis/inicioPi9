...
export default function TelaDicaEstudos() {
  ...
  const [ativo, setAtivo] = useState("Matemática");
          ...
          >
            {materiasOrdenadas.map((item, i) => (
              <TouchableOpacity
                ...
                onPress={() => {
                  setAtivo(item);
                  if (item === "Matemática") router.push('/DicasdeEstudosMatematica');
                  else if (item === "Linguagens") router.push('/DicasEstudos');
                  else if (item === "Natureza") router.push('/DicasdeEstudosNatureza');
                  else if (item === "Humanas") router.push('/DicasdeEstudosHumanas');
                }}
              >
        ...
        <View style={styles.containerCard}>
          <TouchableOpacity style={styles.cardsItem}>
            <View style={styles.cardContentItem}>
              <Entypo name="calculator" size={24} color="#5D64F5" style={styles.icon} />
              <Text style={styles.cardTextoItem}>Aritmética e Álgebra</Text>
            </View>
          </TouchableOpacity>

          <TouchableOpacity style={styles.cardsItem}>
            <View style={styles.cardContentItem}>
              <Octicons name="number" size={24} color="#5D64F5" style={styles.icon} />
              <Text style={styles.cardTextoItem}>Matemática Básica</Text>
            </View>
          </TouchableOpacity>

          <TouchableOpacity style={styles.cardsItem}>
            <View style={styles.cardContentItem}>
              <Entypo name="ruler" size={24} color="#5D64F5" style={styles.icon} />
              <Text style={styles.cardTextoItem}>Geometria</Text>
            </View>
          </TouchableOpacity>

          <TouchableOpacity style={styles.cardsItem}>
            <View style={styles.cardContentItem}>
              <FontAwesome6 name="brain" size={24} color="#5D64F5" style={styles.icon} />
              <Text style={styles.cardTextoItem}>Raciocínio Lógico</Text>
            </View>
          </TouchableOpacity>
        </View>
      </ScrollView>
