...
import { AntDesign, Entypo, FontAwesome, Fontisto, Feather} from '@expo/vector-icons'; // ícone opcional
        ...
        <SafeAreaView style={styles.tela}>
             <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
                <View style={styles.content}>
                    <BotaoVoltar titulo="Sáude Mental" onPress={() => router.push('/HomeLogin')} />
                </View>
